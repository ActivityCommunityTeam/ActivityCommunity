...
public class MY_FragmentAttendAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MY_FragmentAttendAdapter(Context mContext, List<PersonalActivitys> mDatas) {
        this.mContext = mContext;
        this.mDatas = mDatas;
        Log.i("Daniel","MY_FragmentAttendAdapter---MY_FragmentAttendAdapter---mDatas.size()---"+mDatas.size());
        mLayoutInflater = LayoutInflater.from(mContext);
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = mLayoutInflater.inflate(R.layout.my_attend_recyclerview_list, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        Log.i("Daniel","MY_FragmentAttendAdapter---onBindViewHolder---position---"+position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.activity_enrol_time_tv)
        TextView activityEnrolTimeTv;
